  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center mb-6">
        ...
        <h2 className="text-xl font-semibold text-cyan-400">Encryption Learning Lab</h2>
      </div>
      ...
      {!selectedLesson ? (
        ...
        <div className="space-y-6">
          ...
          <div className="glass p-6 rounded-xl">
            <h3 className="text-xl font-semibold text-cyan-300 mb-4">{selectedLesson.title}</h3>
